...
mlf_exp_name = "Finetuning_Qwen25_lora2"
mlflow_path = "/home/timkra/MA/mlflow/mlflow_qwen25_lora2.db"

output_dir = os.path.join(
    os.environ["SCRATCH_DIR"],
    "Qwen2.5-7B-Instruct_MBTI_lora2"
)
...
try:
    ...
    if trainer.is_world_process_zero():
        ...
        trainer.save_model("/home/timkra/MA/output/LoRAadapter/Qwen25_lora2")
        print("Pushing model to hub!")
        trainer.push_to_hub("DrinkIcedT/Qwen2.5-7B-Instruct_MBTI_lora2")
