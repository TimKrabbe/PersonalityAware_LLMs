...
mlf_exp_name = "Finetuning_Ministral-8B_lora2"
mlflow_path = "/home/timkra/MA/mlflow/mlflow_ministral_lora2.db"

output_dir = os.path.join(
    os.environ["SCRATCH_DIR"],
    "Ministral-8B-Instruct-MBTI_lora2"
)
...
try:
    ...
    if trainer.is_world_process_zero():
        ...
        trainer.save_model("/home/timkra/MA/output/LoRAadapter/Ministral_lora2")
        print("Pushing model to hub!")
        trainer.push_to_hub("DrinkIcedT/Ministral-8B_MBTI_lora2")
