...
mlf_exp_name = "Finetuning_Qwen25_lora1"
mlflow_path = "/home/timkra/MA/mlflow/mlflow_qwen25_lora1.db"

output_dir = os.path.join(
    os.environ["SCRATCH_DIR"],
    "Qwen2.5-7B-Instruct_MBTI_lora1"
)
...
class Model_Params:
    ...
    n_epochs: int = 6
    warmup_steps: float = 0.03 #warmup_ratio is deprecated, warmup_steps now takes floats < 1 to do what ratio did
    batch_size: int = 8
...
try:
    ...
    if trainer.is_world_process_zero():
        ...
        trainer.save_model("/home/timkra/MA/output/LoRAadapter/Qwen25_lora1")
        print("Pushing model to hub!")
        trainer.push_to_hub("DrinkIcedT/Qwen2.5-7B-Instruct_MBTI_lora1")
