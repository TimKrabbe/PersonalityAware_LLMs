...
adapter_id = "DrinkIcedT/Ministral-8B-Instruct-MBTI_lora1"
...
def generate_dialogue(scenario, turns=7):
    ...
    for i in range(turns):
        ...
        if i == 0:
            history_a.append({"role": "user", "content": "Please start the conversation. (System note: Continue the conversation naturally.)"})
        ...
        # Hier geben wir B die Aussage von A UND den Hinweis weiterzumachen:
        history_b.append({"role": "user", "content": f"Person A says: {resp_a}\n\n(System note: Continue the conversation naturally.)"})
        # --- TURN B ---
        ...
        # Hier geben wir A die Aussage von B UND den Hinweis weiterzumachen:
...
save_path = "/home/timkra/MA/data/dialogues_ministral_lora1.json"
